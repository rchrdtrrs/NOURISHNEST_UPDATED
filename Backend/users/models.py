...
class UserPayPalSubscription(models.Model):
    ...
    status = models.CharField(max_length=30, choices=Status.choices, default=Status.APPROVAL_PENDING)
...
class PaymentTransaction(models.Model):
    ...
    def __str__(self):
        return f"{self.user.email} - {self.paypal_transaction_id} - ${self.amount}"
